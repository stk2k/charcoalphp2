...
class Net_SMTP
{
     ...
     * @param Charcoal_Integer $port       The port to connect to.
     ...
     *
     * @param Charcoal_String $sender    The sender (reverse path) to set.
     * @param Charcoal_String $params    String containing additional MAIL parameters,
     ...
     *
     * @param Charcoal_String $recipient The recipient (forward path) to add.
     * @param Charcoal_String $params    String containing additional RCPT parameters,
     *                          such as the NOTIFY flags defined by RFC 1891.
     *
     * @return mixed Returns a PEAR_Error with an error message on any
     *               kind of failure, or true on success.
     ...
     *
     * @param Charcoal_String $data  The message text to quote. The string must be passed
     ...
     *                        file resource.
     * @param Charcoal_String $headers The message headers.  If $headers is provided,
