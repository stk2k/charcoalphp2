...
class Net_Socket extends PEAR {
     ...
     * @var Charcoal_String $addr
     */
    var $addr = '';

    /**
     * The port number to connect to.
     * @var Charcoal_Integer $port
     */
    var $port = 0;
     ...
     * @var Charcoal_Integer $lineLength
     */
    var $lineLength = 2048;
     ...
     * @param Charcoal_Integer $port        TCP port number.
     * @param boolean $persistent  (optional) Whether the connection is
     *                             persistent (kept open between requests
     *                             by the web server).
     * @param Charcoal_Integer $timeout     (optional) How long to wait for data.
     ...
     *
     * @param Charcoal_Integer $seconds  Seconds.
     * @param Charcoal_Integer $microseconds  Microseconds.
     * @access public
     * @return mixed true on success or a PEAR_Error instance otherwise
     */
     ...
     *
     * @param Charcoal_Integer $size     Write buffer size.
     * @access public
     ...
     *
     * @param Charcoal_Integer $size  The number of bytes to read from the socket.
     * @access public
     * @return $size bytes of data from the socket, or a PEAR_Error if
     *         not connected.
     */
     ...
     * @param Charcoal_Integer $blocksize  Amount of data to write at once.
     ...
     *
     * @param Charcoal_Integer $state    Which of read/write/error to check for.
     * @param Charcoal_Integer $tv_sec   Number of seconds for timeout.
     * @param Charcoal_Integer $tv_usec  Number of microseconds for timeout.
     *
     * @access public
     ...
     * @param Charcoal_Integer $type     Type of encryption. See
